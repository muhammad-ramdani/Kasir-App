  ...
  return (
    <>
      <Layout titlePage="Data Barang / Produk">
              ...
              <div className="card rounded-4 card-data-barang-100vh width-card-barang">
                <div className="card-body card-body-data-barang">
                  <div className="row">
                    <div className="col-auto">
                      <div className="dropdown me-1">
                        <button type="button" className="btn btn-outline-light btn-filter-data-barang rounded-3" data-bs-toggle="dropdown" aria-expanded="false" data-bs-offset="0,10">
                          <img src={sort} />
                        </button>
                        <ul className="dropdown-menu shadow dropdown-menu-filter-data-barang">
                          <li>
                            <a className="dropdown-item dropdown-item-filter-data-barang" href="#">
                              Barang
                            </a>
                          </li>
                          <li>
                    ...
                    <div className="col ps-0">
                      <div className="input-group flex-nowrap mt-0">
                        <img src={searchNormal} className="input-group-text bg-white rounded-start-3" alt="" />
                  ...
                  <div className="group-button-filter-kategori-barang">
                    <button type="button" className="btn rounded-3 button-filter-kategori-barang-active">
                      Semua
                    </button>
                    <button type="button" className="btn rounded-3 button-filter-kategori-barang">
                      Snack
                    </button>
                    <button type="button" className="btn rounded-3 button-filter-kategori-barang">
                      Alat Rumah Tangga
                  ...
                  <div className="content-fill-manajemen-data-barang overflow-auto">
                    <div className="card rounded-4 mb-3">
                      <div className="row m-0">
                        <div className="col-auto p-0">
                          <img src={chitato} className="images-card-barang" />
                        </div>
                        <div className="col p-0">
                          <div className="card-body ps-0">
                            <div className="row">
                              <div className="col">
                                <span className="fw-medium">Chitato Rasa Sapi Panggang 68 gr</span>
                                <br />
                              ...
                              <div className="col-auto text-end">
                                <span className="fw-medium" style={{ color: "#FF0000" }}>
                                  100
                                </span>
                                <br />
                    ...
                    <div className="card rounded-4 mb-3 card-barang-active">
                      <div className="row m-0">
                        <div className="col-auto p-0">
                          <img src={tisuPaseo} className="images-card-barang" />
                        </div>
                        <div className="col p-0">
                          <div className="card-body ps-0">
                            <div className="row">
                              <div className="col">
                                <span className="fw-medium">Tisu Paseo 2 Lapis 250 Lembar</span>
                                <br />
                                <span className="small" style={{ color: "#646464" }}>
                                  000002
                                </span>
        ...
        {/* Modal Tambah Barang */}
        <div className="modal fade" id="modalTambahBarangDicardDataBarang" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog modal-dialog-scrollable" style={{ width: 605 }}>
            <div className="modal-content shadow rounded-4 p-0" style={{ width: 605 }}>
              <div className="modal-header" style={{ margin: "32px 32px 0 32px", padding: "0 0 18px 0" }}>
                ...
                <button type="button" className="btn-close btn-close-tambah-data-barang" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div className="modal-body" style={{ padding: "20px 23px 20px 32px", margin: "0px 3px 0px 0px" }}>
                <div className="text-center mb-3">
                  <img src={noImagesForTambahBarang} style={{ width: 100, height: 100, marginBottom: 10 }} className="border rounded-4 mt-1" />
                  <div className="">
                ...
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control rounded-3 form-control-input-nama-barang" id="inputNamaBarang" placeholder="Masukan nama.." />
                </div>
                <div className="mb-3">
                ...
                <div style={{ marginBottom: 20 }}>
                  <div className="form-check mb-2">
                    <input className="form-check-input form-check-input-tampilkanDiTransaksi-dan-pakaiStok rounded-2" type="checkbox" defaultValue="" id="flexCheckTampilkanDiTransaksi" defaultChecked />
                    <label className="form-check-label mt-0" htmlFor="flexCheckTampilkanDiTransaksi">
                      Tampilkan di Transaksi
                    </label>
                  </div>
                  <div className="form-check mb-0">
                    <input className="form-check-input form-check-input-tampilkanDiTransaksi-dan-pakaiStok rounded-2" type="checkbox" defaultValue="" id="flexCheckPakaiStok" />
                ...
                <div className="row m-0 mb-3">
                  <div className="col-auto p-0" style={{ marginRight: 20 }}>
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-stok-barang" id="inputStokBarang" placeholder="0" style={{ width: 193 }} />
                  </div>
                  <div className="col p-0" style={{ marginRight: 10 }}>
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-kode-barang" id="inputKodeBarang" placeholder="Masukkan kode" />
                  </div>
                  <div className="col-auto p-0 align-self-end">
                    <input type="text" className="form-control rounded-3 form-control-input-refresh-disabled" id="inputRefreshDisabled" style={{ width: 45 }} disabled />
                  </div>
                </div>
                <div className="row m-0 mb-3">
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-harga-dasar" id="inputHargaDasar" placeholder="Rp 0" />
                  </div>
                  <div className="col-auto p-0" style={{ marginRight: 20 }} />
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-harga-jual" id="inputHargaJual" placeholder="Rp 0" />
                  </div>
                </div>
                <div className="mb-3">
                ...
                <div className="row m-0 mb-3">
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-batas-minimum-stok" id="inputBatasMinimumStok" placeholder="0" />
                  </div>
                  <div className="col-auto p-0" style={{ marginRight: 20 }} />
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-letak-rak" id="inputLetakRak" placeholder="Masukkan letak" />
                  </div>
                </div>
                <div className="row m-0 mb-3">
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-berat-rincian-barang" id="inputBeratRincianBarang" placeholder="0" />
                  </div>
                  <div className="col-auto p-0" style={{ marginRight: 20 }} />
                  <div className="col p-0">
                ...
                <div className="row m-0 mb-3">
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-diskon-harga-barang" id="inputDiskonHargaBarang" placeholder="0" />
                  </div>
                  <div className="col-auto p-0" style={{ marginRight: 10 }} />
                  <div className="col-auto p-0 align-self-end">
                    <input type="radio" className="btn-check" name="options-outlined-diskon-persen-atau-rp" id="radioDiskonPersenAtauRp-1" autoComplete="off" defaultChecked />
                    <label className="btn fw-medium rounded-start-3 border-end-0 rounded-end-0 class-diskon-persen-atau-rp my-0" htmlFor="radioDiskonPersenAtauRp-1" style={{ marginRight: "-5px", padding: "9.5px 18.15px" }}>
                      %
                    </label>
                    <input type="radio" className="btn-check" name="options-outlined-diskon-persen-atau-rp" id="radioDiskonPersenAtauRp-2" autoComplete="off" />
                    <label className="btn fw-medium rounded-end-3 border-start-0 rounded-start-0 class-diskon-persen-atau-rp my-0" htmlFor="radioDiskonPersenAtauRp-2" style={{ padding: "9.5px 14.02px" }}>
                      Rp
                    </label>
                  </div>
                </div>
                <div className="mb-2">
                  ...
                  <input type="text" className="form-control rounded-3 form-control-input-keterangan-barang" id="inputKeteranganBarang" placeholder="Masukkan keterangan" />
                </div>
              </div>
              <div className="modal-footer border-0" style={{ padding: "25px 32px 32px 32px" }}>
                <button type="submit" className="btn btn-simpan-data-barang fw-semibold w-100 border-0 rounded-3 m-0">
                  Simpan
                </button>
              </div>
            </div>
        ...
        {/* Modal Edit Barang */}
        <div className="modal fade" id="modalEditRincianDataBarang" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div className="modal-dialog modal-dialog-scrollable" style={{ width: 900 }}>
            <div className="modal-content shadow rounded-4 p-0" style={{ width: 900 }}>
              ...
              <div className="modal-body" style={{ padding: "20px 23px 20px 32px", margin: "0px 3px 0px 0px" }}>
                <div className="text-center mb-3">
                  <img src={tisuPaseo} style={{ width: 100, height: 100, marginBottom: 10 }} className="border rounded-4 mt-1" />
                  <div className="">
                    <label htmlFor="uploadImage" className="btn btn-sm fw-medium text-white border-0 rounded-3 mt-0 mb-0" style={{ backgroundColor: "#FF0000", padding: "4.5px 20.32px" }}>
                      <img src={logoEditRincianBarangWhite} />
                      Ubah
                ...
                <div className="mb-3">
                  ...
                  <input type="text" className="form-control rounded-3 form-control-input-nama-barang" id="inputNamaBarang" placeholder="Masukan nama.." value="Tissue Paseo 2 Lapis 250 Lembar" />
                </div>
                <div className="mb-3">
                  <label className="form-label mt-0">Tipe Barang</label>
                  <select className="form-select rounded-3 form-select-tipe-barang">
                ...
                <div className="row m-0 mb-3">
                  <div className="col-auto p-0" style={{ marginRight: 20 }}>
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-stok-barang" id="inputStokBarang" placeholder="0" style={{ width: 193 }} value="145" />
                  </div>
                  <div className="col p-0" style={{ marginRight: 10 }}>
                    <label htmlFor="inputKodeBarang" className="form-label mt-0">
                      Kode Barang<span className="text-danger">*</span>
                    </label>
                    <input type="text" className="form-control rounded-3 form-control-input-kode-barang" id="inputKodeBarang" placeholder="Masukkan kode" value="000002" />
                  </div>
                  <div className="col-auto p-0 align-self-end">
                    <input type="text" className="form-control rounded-3 form-control-input-refresh-disabled" id="inputRefreshDisabled" style={{ width: 45 }} disabled />
                  </div>
                ...
                <div className="row m-0 mb-3">
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-harga-dasar" id="inputHargaDasar" placeholder="Rp 0" value="Rp 9.000" />
                  </div>
                  <div className="col-auto p-0" style={{ marginRight: 20 }} />
                  <div className="col p-0">
                    <label htmlFor="inputHargaJual" className="form-label mt-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-harga-jual" id="inputHargaJual" placeholder="Rp 0" value="Rp 11.000" />
                  </div>
                </div>
                <div className="mb-3">
                  <label className="form-label mt-0">Kategori</label>
                ...
                <div className="row m-0 mb-3">
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-batas-minimum-stok" id="inputBatasMinimumStok" placeholder="0" value="50" />
                  </div>
                  <div className="col-auto p-0" style={{ marginRight: 20 }} />
                  <div className="col p-0">
                    <label htmlFor="inputLetakRak" className="form-label mt-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-letak-rak" id="inputLetakRak" placeholder="Masukkan letak" value="Rak B" />
                  </div>
                </div>
                <div className="row m-0 mb-3">
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-berat-rincian-barang" id="inputBeratRincianBarang" placeholder="0" value="25" />
                  </div>
                  <div className="col-auto p-0" style={{ marginRight: 20 }} />
                  <div className="col p-0">
                    <label className="form-label mt-0">Satuan</label>
                ...
                <div className="row m-0 mb-3">
                  <div className="col p-0">
                    ...
                    <input type="text" className="form-control rounded-3 form-control-input-diskon-harga-barang" id="inputDiskonHargaBarang" placeholder="0" value="20" />
                  </div>
                  <div className="col-auto p-0" style={{ marginRight: 10 }} />
                  <div className="col-auto p-0 align-self-end">
                    <input type="radio" className="btn-check" name="options-outlined-diskon-persen-atau-rp-edit" id="radioDiskonPersenAtauRp-edit-1" autoComplete="off" defaultChecked />
                    <label className="btn fw-medium rounded-start-3 border-end-0 rounded-end-0 class-diskon-persen-atau-rp my-0" htmlFor="radioDiskonPersenAtauRp-edit-1" style={{ marginRight: "-5px", padding: "9.5px 18.15px" }}>
                      %
                    </label>
                    <input type="radio" className="btn-check" name="options-outlined-diskon-persen-atau-rp-edit" id="radioDiskonPersenAtauRp-edit-2" autoComplete="off" />
                    <label className="btn fw-medium rounded-end-3 border-start-0 rounded-start-0 class-diskon-persen-atau-rp my-0" htmlFor="radioDiskonPersenAtauRp-edit-2" style={{ padding: "9.5px 14.02px" }}>
                      Rp
                    </label>
                  </div>
                </div>
                <div className="mb-2">
                  ...
                  <input type="text" className="form-control rounded-3 form-control-input-keterangan-barang" id="inputKeteranganBarang" placeholder="Masukkan keterangan" value="-" />
                </div>
              </div>
              <div className="modal-footer border-0" style={{ padding: "25px 32px 32px 32px" }}>
                <button type="submit" className="btn btn-simpan-data-barang fw-semibold w-100 border-0 rounded-3 m-0">
